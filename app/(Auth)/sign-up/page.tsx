          ...
          <div className="max-w-md mx-auto text-white">
            ...
            <div className="flex justify-center items-center">
              <div>
                ...
                <button className="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-orange-500 focus:ring-offset-orange-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mt-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
